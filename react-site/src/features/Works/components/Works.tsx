...
type Props = {
  ...
  endClass?: string;
  triggerOnce?: boolean;
  inViewFunc?: (p: keyof typeof pages) => void;
};

export const Works = React.forwardRef<HTMLElement, Props>(
  (
    {
      rootMargin = "100px",
      startClass = "",
    ...
    return (
      <section className={global.section} ref={scrollRef}>
        <div className={global.sectionHeader} >
          <h3 className={global.sectionTitle}>Works</h3>
        </div>
